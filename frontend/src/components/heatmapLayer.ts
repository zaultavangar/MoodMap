...
const getMaxArticleCount = (countKey: string, features: Feature[]): number => {
  const counts: number[] = features.map((feature, index) => {
    ...
    if (feature.properties !== null && feature.properties[countKey] !== null && feature.properties[countKey] !== undefined){
  ...
  const circleLayer: CircleLayer = {
    ...
    paint: {
        ...
        [
            ...
            ['linear'],
            ['get', sentimentKey],
            0.2, "#ff0000",       // Low sentiment
            0.7, "#00ff00"     // High sentiment
        ],
        'circle-opacity': 0.75
    }
  };
  ...
  id: 'heatmap',
    ...
    paint: {
        ...
        'circle-radius': [
          ...
          ['zoom'],
          7, 
          ['interpolate', ['exponential', 5], ['get', "11-2023-count"], 1, 4, 150, 12],
          16, 
          ['interpolate', ['exponential', 5], ['get', "11-2023-count"], 1, 8, 150, 24]
        ],
        ...
        'circle-color': [
            ...
            0, "#ff0000",       // Low sentiment
            0.5, "#ffa500",  // Medium sentiment
            1, "#ffff00"     // High sentiment
        ],

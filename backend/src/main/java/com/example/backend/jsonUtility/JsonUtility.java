...
public class JsonUtility<T> {
     ...
     */
    public T readJson(String json, Class<T> type) throws IOException {
     ...
     */
    public T readJson(String json, Type type) throws IOException {
      JsonAdapter<T> adapter = moshi.adapter(type);
      return adapter.fromJson(json);
    }
     ...
     */
    public String serialize(T object, Class<T> classOfT) {

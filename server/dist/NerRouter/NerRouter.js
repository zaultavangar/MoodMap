...
exports.NerRouter = void 0;
const express_1 = __importDefault(require("express"));
const NerExpressRouter = express_1.default.Router();
class NerRouter {
    constructor() {
        this.nerQuery = (data) => __awaiter(this, void 0, void 0, function* () {
        ...
        this.getExpressRouter = () => {
            return NerExpressRouter;
        };
        NerExpressRouter.post('/', (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                const text = req.body.text;
                const data = { "inputs": text };
                const bertNERRes = yield this.nerQuery(data);
